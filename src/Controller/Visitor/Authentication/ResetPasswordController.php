...
class ResetPasswordController extends AbstractController
{
    ...
    {
        if ($token) {
            // Nous stockons le token en session et le supprimons de l'URL, pour éviter que l'URL ne soit
                // chargé dans un navigateur et potentiellement divulgué le jeton à du JavaScript tiers.
        ...
        if ($form->isSubmitted() && $form->isValid()) 
        {
            ...
            $this->addFlash('succes','Le mot de passe a éyé réinitialisé. Vous pouvez vous connecter.');
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address('medecine-du-monde@gmail.com', 'Julie Dupont'))
            ->to($user->getEmail())
            ->subject("Réinitialisation de votre mot de passe sur le blog de Julie Dupont")
